...
// Add dbConnection to the container.
...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.AllowAnyOrigin(); //url tujuan
        //policy.WithOrigins(); //kqalo nanti dist url in real case
        policy.AllowAnyHeader(); //
        policy.AllowAnyMethod(); //hanaya bisa method apa
    });
});
